...
declare class IrisChatLib extends NSObject {
	...
	static initIrisChatLibraryWithSecretRootViewControllerAndBaseURLAndSLLPinningAndSSLPublicKeyOneAndSSLPublicKeyTwoAndSSLPublicError(applicationSecret: string, rootViewController: UIViewController, alternateBaseUrl: string, pinningType: SSL_PINNING_TYPE, sslPublicKeyOne: string, sslPublicKeyTwo: string, sslPublicKeyError: string): IrisChatLib;

	static initIrisChatLibraryWithSecretRootViewControllerAndBaseURLAndSLLPinningAndSSLPublicKeyOneAndSSLPublicKeyTwoAndSSLPublicErrorAndHTTPHeadersDictionary(applicationSecret: string, rootViewController: UIViewController, alternateBaseUrl: string, pinningType: SSL_PINNING_TYPE, sslPublicKeyOne: string, sslPublicKeyTwo: string, sslPublicKeyError: string, httpHeadersDictionary: NSDictionary<any, any>): IrisChatLib;
	...
	sslPublicKeyOne: string;

	sslPublicKeyTwo: string;
	...
	setHttpHeadersDictionary(httpHeadersDictionary: NSDictionary<any, any>): void;
}
